...
export const products: Product[] = [
  ...
  },
  {
    ...
    colors: ['Stone'],
    sizes: ['S', 'M', 'L', 'XL'],
    images: [img('product_cotton_overshirt.jpg'), img('lookbook_02_1789735669341.jpg')],
    featured: false,
    newArrival: true,
    gender: 'men',
    number: '06',
  },
  {
    ...
    details: 'Single-breasted, zip closure with neat collar. Straight clean hem. Slightly relaxed shoulder. Fully lined.',
    materials: '90% Wool, 10% Nylon.',
    careInstructions: 'Dry clean only.',
    colors: ['Ivory'],
    sizes: ['XS', 'S', 'M', 'L'],
    images: [img('product_cropped_jacket.jpg'), img('women_category_1789735625285.jpg')],
    featured: false,
    newArrival: false,
    gender: 'women',
    number: '07',
  ...
  {
    id: 'double-breasted-coat-men',
    name: 'Double-Breasted Wool Overcoat',
    category: 'outerwear',
    minimumOrderQuantity: 20,
    description: 'A structured double-breasted overcoat tailored in a dense melton wool. Clean lapel, sharp shoulder line, and an architectural knee-length drape.',
    details: 'Double-breasted construction with a structured shoulder. Broad notched lapels, two side pockets, welt chest pocket. Fully lined.',
    materials: '100% Melton Wool.',
    careInstructions: 'Dry clean only. Store on a contoured hanger.',
    colors: ['Charcoal'],
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  ...
  {
    id: 'relaxed-crewneck-knit',
    name: 'Relaxed Crewneck Knit',
    category: 'knitwear',
    minimumOrderQuantity: 30,
    description: 'A relaxed-silhouette knit crafted from a soft merino-cashmere blend. Designed with a dropped shoulder and clean ribbed collar.',
    details: 'Semi-relaxed body with a classic ribbed crewneck collar, wide cuffs, and hem. Pairs effortlessly with tailored trousers.',
  ...
  },
  {
    ...
    details: 'Three card slots per side. Central bill pocket. Dimensions: 10 × 7.5 cm. Subtle edge-burnished finish.',
    materials: 'Vegetable-tanned calf leather.',
    careInstructions: 'Wipe clean with a dry cloth.',
    colors: ['Black'],
    sizes: ['One Size'],
    images: [img('product_leather_cardholder.jpg')],
    featured: false,
    newArrival: false,
    gender: 'unisex',
    number: '11',
  },
  {
    ...
    details: 'Full-grain calfskin leather upper. Leather lining. Minimal rubber cupsole. Six-eyelet lacing. Tonal stitching throughout.',
    ...
    images: [img('product_leather_sneaker.jpg')],
    featured: false,
    newArrival: false,
    gender: 'unisex',
    number: '12',
